...
public class DriveCommand extends Command {
    ...
    public void onLoop() {
         ...
         * cameraMode.forceSetNumber(1); } else if(!isTracking &&
         * cameraMode.getNumber(0).equals(1)){ cameraMode.forceSetNumber(0); }
         */
