...
public class RobotMap {
    ...
    public static final int DRIVE_RIGHT_1 = Robot.OutBall ? 6 : 6;
    ...
    public static final int INTAKE_ARM = Robot.OutBall? 8 : -1;

    //PWM IDs

    public static final int INTAKE = Robot.OutBall? 9 : -1;
    public static final int OUTTAKE = Robot.OutBall? 7 : -1;
    public static final int CONVEYOR = Robot.OutBall? 6 : -1;
